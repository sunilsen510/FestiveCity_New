  ...
  return (
    <>
      <section className="relative w-full h-auto overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center justify-center gap-8 text-center px-4 sm:px-6 lg:px-0">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[65px] mt-2 font-bold text-white leading-snug md:leading-tight lg:mb-10 md:mb-5"
            >
              <span className="text-yellow-color">Your Event, </span>
              <span>Our Passion</span>
            </motion.h2>
            ...
            <motion.div
              variants={fadeUp}
              className="flex items-center justify-center rounded-3xl md:rounded-[60px] overflow-hidden cursor-pointer w-full max-w-[1296px]"
            ...
            >
              <Link href="/" className="inline-block w-full">
                <Image
                  ...
                  width={1296}
                  height={576}
                  className="w-full h-auto object-cover rounded-3xl md:rounded-[60px]"
                />
              </Link>
            </motion.div>

            {/* CTA Button */}
            <motion.div variants={fadeUp} className="mt-10 md:mt-16">
              <Link
                href="/partner"
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
            className="flex items-center justify-center w-full flex-col gap-5 mt-0 md:mt-0"
          >
            <FeaturedServices
              title="Trending"
              subtitle="Partners"
      ...
      <section className="relative w-full h-auto overflow-hidden">
        ...
        {/* Network Content */}
        <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center justify-center gap-8 pb-[45px] lg:pb-20 px-4 sm:px-6 lg:px-0 text-center">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
