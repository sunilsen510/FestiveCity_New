    ...
    <>
      ...
      <div className="mask-image gradient_border_mask p-[1px] rounded-[20px] group relative overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="bg-black-linear rounded-[20px] w-[calc(100%-2px)] h-[calc(100%-2px)] absolute top-[1px] left-[1px] p-5 pr-20 flex flex-col justify-end flex-wrap transition-all duration-300 ease-in-out">
